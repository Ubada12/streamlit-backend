...
class FloodAlertEmailPayload(BaseModel):
    ...
    # Event metadata
    Timestamp:      str = Field(..., description="ISO datetime of detection, e.g. '2025-06-25T14:32:00'")
    risk:           str = Field(..., description="Flood risk level: High | Moderate | Low | Minimal")

    # Location
    address:        str = Field(..., description="Full human-readable address from reverse geocoding")
