...
2. Move the downloaded file to the `ml_models/` directory.  

Alternatively, you can use the following command:  
```bash
wget "https://drive.google.com/uc?export=download&id=1B6NoDc4ejFL4ogkzpIOb4dbLpiSngpSn" -O ml_models/vgg16_model.keras
```
